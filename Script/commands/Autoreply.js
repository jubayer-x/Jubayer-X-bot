...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ jubayer  ☜\nFacebook: https://www.facebook.com/MD.JUBAYER.SIKDER.OFFICIAL.ID\nWhatsApp: +0574289965",
    "admin": "He is Jubayer Baby তাকে সবাই Baby হিসেবে চিনে😘☺️",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝐉𝐮𝐛𝐚𝐲𝐞𝐫 𝐗 𝐁𝐨𝐭 ",
